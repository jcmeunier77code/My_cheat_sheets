...
ConfigFile has three parts:
  1. metadate (as specified in yaml and render by 'describe' command)
  2. spec (as specified in yaml and render by 'describe' command)
  3. status (automatically generated by k8s when pject is deployed)
